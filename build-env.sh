...
'cmake')
tn='cmake-3.9.4'; url='http://cmake.org/files/v3.9/cmake-3.9.4.tar.gz';
set_source 'tar';
...
'gzip')
tn='gzip-1.8'; url='http://ftp.gnu.org/gnu/gzip/gzip-1.8.tar.xz';
set_source 'tar';
...
'p7zip')
tn='p7zip_16.02'; url='https://sourceforge.net/projects/p7zip/files/p7zip/16.02/p7zip_16.02_src_all.tar.bz2/download';
set_source 'tar';
do_make;do_make all; ./install.sh; 
		shift;;
		
'tar')
tn='tar-1.29'; url='http://ftp.gnu.org/gnu/tar/tar-1.29.tar.xz';
set_source 'tar';
...
'mpfr')
tn='mpfr-3.1.6'; url='http://ftp.gnu.org/gnu/mpfr/mpfr-3.1.6.tar.xz';
set_source 'tar';
...
'mpc')
tn='mpc-1.0.3'; url='http://ftp.gnu.org/gnu/mpc/mpc-1.0.3.tar.gz';
set_source 'tar';
configure_build --prefix=`_install_prefix`;
do_make;do_make install-strip;do_make install;do_make all;
		shift;;
...
'coreutils')
tn='coreutils-8.28'; url='http://ftp.gnu.org/gnu/coreutils/coreutils-8.28.tar.xz';
set_source 'tar';
...
'binutils')
tn='binutils-2.29.1'; url='http://ftp.ntua.gr/mirror/gnu/binutils/binutils-2.29.1.tar.gz';
set_source 'tar';
...
'libtasn1')
tn='libtasn1-4.12'; url='http://ftp.gnu.org/gnu/libtasn1/libtasn1-4.12.tar.gz';
set_source 'tar';
configure_build --prefix=`_install_prefix`; 
do_make;do_make lib;do_make install-strip;do_make install;do_make all;  	
		shift;;
...
'libunistring')
tn='libunistring-0.9.7'; url='http://ftp.gnu.org/gnu/libunistring/libunistring-0.9.7.tar.xz';
set_source 'tar';
configure_build --enable-threads=posix --prefix=`_install_prefix`; 
do_make;do_make lib;do_make install-strip;do_make install;do_make all;
		shift;;
...
'libsodium')
tn='libsodium-1.0.15'; url='https://github.com/jedisct1/libsodium/releases/download/1.0.15/libsodium-1.0.15.tar.gz';
set_source 'tar';
...
'unbound')
tn='unbound-1.6.7'; url='http://www.unbound.net/downloads/unbound-1.6.7.tar.gz';
set_source 'tar';
...
'p11-kit')
tn='p11-kit-0.23.2'; url='http://p11-glue.freedesktop.org/releases/p11-kit-0.23.2.tar.gz';
set_source 'tar';
...
'glib')
tn='glib-2.55.0'; url='http://ftp.acc.umu.se/pub/gnome/sources/glib/2.55/glib-2.55.0.tar.xz';
set_source 'tar';
...
'libatomic_ops')
tn='libatomic_ops-7.4.4'; url='http://www.hboehm.info/gc/gc_source/libatomic_ops-7.4.4.tar.gz';
set_source 'tar';
configure_build --enable-shared --prefix=`_install_prefix`; 
do_make;do_make install-strip;do_make install;do_make all;
		shift;;
...
'gc')
tn='gc-7.6.0'; url='http://www.hboehm.info/gc/gc_source/gc-7.6.0.tar.gz';
set_source 'tar';
...
'expect')
tn='expect5.45'; url='http://sourceforge.net/projects/expect/files/Expect/5.45/expect5.45.tar.gz/download';
set_source 'tar';
...
'libxml2')
tn='libxml2-2.9.6'; url='http://xmlsoft.org/sources/libxml2-2.9.6.tar.gz';
set_source 'tar';
...
'libxslt')
tn='libxslt-1.1.31'; url='http://xmlsoft.org/sources/libxslt-1.1.31.tar.gz';
set_source 'tar';
configure_build --prefix=`_install_prefix`; 
do_make;do_make install-strip;do_make install;do_make all; 	
		shift;;
...
'gdbm')
tn='gdbm-1.13'; url='http://ftp.gnu.org/gnu/gdbm/gdbm-1.13.tar.gz';
set_source 'tar';
sed -i 's/ncurses/ncursesw/g' configure;
...
'gperftools')
tn='gperftools-2.6.1'; url='http://github.com/gperftools/gperftools/releases/download/gperftools-2.6.1/gperftools-2.6.1.tar.gz';
set_source 'tar';
...
're2')
tn='re2-2017-08-01'; url='http://github.com/google/re2/archive/2017-08-01.tar.gz';
set_source 'tar';
do_make;do_make lib; do_make install;do_make all; 
		shift;;
	
'icu4c')
tn='icu/source'; url='http://download.icu-project.org/files/icu4c/60.1/icu4c-60_1-src.tgz';
set_source 'tar';echo '' > LICENSE;
configure_build --enable-rpath --enable-plugins --prefix=`_install_prefix`; 
do_make;do_make lib;do_make install;do_make all;
		shift;;
		
'boost')
tn='boost_1_65_1'; url='http://dl.bintray.com/boostorg/release/1.65.1/source/boost_1_65_1.tar.gz';
set_source 'tar';
...
'libgcrypt')
tn='libgcrypt-1.8.1'; url='ftp://ftp.gnupg.org/gcrypt/libgcrypt/libgcrypt-1.8.1.tar.gz';
set_source 'tar';
...
'cryptopp')
tn='cryptopp-CRYPTOPP_5_6_5'; url='http://github.com/weidai11/cryptopp/archive/CRYPTOPP_5_6_5.tar.gz';
set_source 'tar';
cmake_build -DCMAKE_INSTALL_PREFIX=`_install_prefix`;
do_make;do_make install;do_make all; 
		shift;;	
...
'libuv')
tn='libuv-v1.16.1'; url='https://dist.libuv.org/dist/v1.16.1/libuv-v1.16.1.tar.gz';
set_source 'tar';
autogen_build;configure_build --prefix=`_install_prefix`; 
do_make;do_make install-strip;do_make install;do_make all; 
		shift;;	
...
'libjpeg')
tn='jpeg-9b'; url='http://www.ijg.org/files/jpegsrc.v9b.tar.gz';
set_source 'tar';
configure_build --prefix=`_install_prefix`;
do_make;do_make install-strip;do_make install;do_make all;
		shift;;	
...
'freetype')
tn='freetype-2.8.1'; url='http://download.savannah.gnu.org/releases/freetype/freetype-2.8.1.tar.gz';
set_source 'tar';
...
'harfbuzz')
tn='harfbuzz-1.5.1'; url='http://www.freedesktop.org/software/harfbuzz/release/harfbuzz-1.5.1.tar.bz2';
set_source 'tar';
...
'fontconfig')
tn='fontconfig-2.12.6'; url='http://www.freedesktop.org/software/fontconfig/release/fontconfig-2.12.6.tar.gz';
set_source 'tar';
...
'openjdk')	
tn='jdk1.8.0_162'; url='http://download.java.net/java/jdk8u162/archive/b03/binaries/jdk-8u162-ea-bin-b03-linux-x64-24_oct_2017.tar.gz';
set_source 'tar';
...
if [ -f $CUST_JAVA_INST_PREFIX/$sn/bin/javac ] &&  [ -f $CUST_JAVA_INST_PREFIX/$sn/jre/bin/java ]; then
	...
	echo -e $CUST_JAVA_INST_PREFIX/$sn/jre/lib/amd64/server/ > $LD_CONF_PATH/$sn.conf;
fi
		shift;;	
		
'apache-ant')
tn='apache-ant-1.10.1'; url='http://www.apache.org/dist/ant/source/apache-ant-1.10.1-src.tar.gz';
set_source 'tar';
...
set_source 'tar';
cmake_build -DUSE_STD_THREAD=1 -DWITH_STDTHREADS=ON; #-DWITH_BOOSTTHREADS=ON
do_make;do_make install;do_make all;
...
'gmock')
tn='googletest-release-1.8.0'; url='https://github.com/google/googletest/archive/release-1.8.0.tar.gz';
set_source 'tar';
cmake_build -DCMAKE_INSTALL_PREFIX=`_install_prefix`;
do_make;do_make install;
		shift;;	
...
'curl')
tn='curl-curl-7_56_1'; url='https://github.com/curl/curl/archive/curl-7_56_1.tar.gz';
set_source 'tar';
cmake_build -DCMAKE_INSTALL_PREFIX=`_install_prefix`;
do_make;do_make install;
		shift;;	
...
'protobuf')
tn='protobuf-3.4.1'; url='http://github.com/google/protobuf/archive/v3.4.1.tar.gz';
set_source 'tar';
...
'apache-hadoop')
tn='hadoop-2.7.4'; url='http://apache.crihan.fr/dist/hadoop/common/hadoop-2.7.4/hadoop-2.7.4.tar.gz';
set_source 'tar';
...
echo "export HADOOP_VERSION=\"2.7.4\"" >> $ENV_SETTINGS_PATH/$sn.sh
...
'nodejs')
tn='node-v8.9.1'; url='http://nodejs.org/dist/latest-v8.x/node-v8.9.1.tar.xz';
set_source 'tar';
...
'libzip')
tn='libzip-1.3.0'; url='http://nih.at/libzip/libzip-1.3.0.tar.xz';
set_source 'tar';
configure_build --prefix=`_install_prefix`;
do_make;do_make install;	
		shift;;
...
'gawk')
tn='gawk-4.1.4'; url='http://ftp.gnu.org/gnu/gawk/gawk-4.1.4.tar.xz';
set_source 'tar';
configure_build --prefix=`_install_prefix`;
do_make;do_make install;	
		shift;;
...
'llvm')
tn='llvm-5.0.0.src'; url='http://releases.llvm.org/5.0.0/llvm-5.0.0.src.tar.xz';
set_source 'tar';
...
'libsigcplusplus')
tn='libsigcplusplus-2.99.9'; url='http://github.com/GNOME/libsigcplusplus/archive/2.99.9.tar.gz';
set_source 'tar';
cmake_build -DCMAKE_INSTALL_PREFIX=`_install_prefix`;
do_make;do_make install;	
		shift;;
...
'cairo')
tn='cairo-1.14.10'; url='http://www.cairographics.org/releases/cairo-1.14.10.tar.xz';
set_source 'tar';
...
'gobject-ispec')
tn='gobject-introspection-1.54.1'; url='http://ftp.gnome.org/pub/gnome/sources/gobject-introspection/1.54/gobject-introspection-1.54.1.tar.xz';
set_source 'tar';
configure_build  --prefix=`_install_prefix`;
do_make;do_make install;	
		shift;;	
...
'pango')
tn='pango-1.40.12'; url='http://ftp.acc.umu.se/pub/GNOME/sources/pango/1.40/pango-1.40.12.tar.xz';
set_source 'tar';
configure_build --prefix=`_install_prefix`;
do_make;do_make install;	
		shift;;	
...
'rrdtool')
tn='rrdtool-1.7.0'; url='http://oss.oetiker.ch/rrdtool/pub/rrdtool-1.7.0.tar.gz';
set_source 'tar';
...
'gdb')
tn='gdb-8.0.1'; url='http://ftp.gnu.org/gnu/gdb/gdb-8.0.1.tar.xz';
set_source 'tar';
configure_build --prefix=`_install_prefix`;
do_make;do_make install;
		shift;;	
...
'kerberos')
tn='krb5-1.15.2'; url='http://web.mit.edu/kerberos/dist/krb5/1.15/krb5-1.15.2.tar.gz';
set_source 'tar';
...
'clang')
tn='cfe-5.0.0.src'; url='http://releases.llvm.org/5.0.0/cfe-5.0.0.src.tar.xz';
set_source 'tar';
cmake_build -DCMAKE_INSTALL_PREFIX=`_install_prefix`;
do_make;do_make install;	
		shift;;
...
'php')
tn='php-7.1.10'; url='http://mirror.cogentco.com/pub/php/php-7.1.10.tar.xz';
set_source 'tar';
...
'libnftnl')
tn='libnftnl-1.0.8'; url='http://www.netfilter.org/projects/libnftnl/files/libnftnl-1.0.8.tar.bz2';
set_source 'tar';
configure_build --enable-static --enable-shared --prefix=`_install_prefix`;
do_make;do_make install;	
		shift;;
...
'nftables')
tn='nftables-0.8'; url='http://www.netfilter.org/projects/nftables/files/nftables-0.8.tar.bz2';
set_source 'tar';
...
'libhdfs3')
tn='pivotalrd-libhdfs3-2.2.31'; url='http://github.com/Pivotal-Data-Attic/pivotalrd-libhdfs3/archive/v2.2.31.tar.gz';
set_source 'tar';
...
'glibc')
tn='glibc-2.26'; url='http://ftp.gnu.org/gnu/libc/glibc-2.26.tar.xz';
set_source 'tar'; 
...
'bash')
tn='bash-4.4.12'; url='http://ftp.gnu.org/gnu/bash/bash-4.4.12.tar.gz';
set_source 'tar';
sed -i 's/ncurses/ncursesw/g' configure;
configure_build --prefix=`_install_prefix`; 
do_make;do_make install;
...
'ncurses')
tn='ncurses-6.0'; url='http://ftp.gnu.org/gnu/ncurses/ncurses-6.0.tar.gz';
set_source 'tar';
...
compile_and_install(){
	...
	if [ $stage -ne 3 ]; then
		do_install coreutils gdb bash curl sqlite berkeley-db python boost 
	fi
	if [ $stage -eq 2 ]; then
		...
		do_install gmock protobuf apache-hadoop libgsasl libhdfs3
	...
	if [ $stage -eq 3 ]; then
		...
		do_install rrdtool hypertable python3 pypy2stm # ganglia 
	fi
} 
#########
